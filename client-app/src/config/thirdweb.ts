...
// EventFactory ABI (simplified for main functions)
...
// Event ABI (simplified for main functions)
...
export const wallets = [
  inAppWallet({
    executionMode: {
      mode: "EIP4337",
      smartAccount: { chain: etherlinkTestnet, sponsorGas: true },
    },
  }),
];
