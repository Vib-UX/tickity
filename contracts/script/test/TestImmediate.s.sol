...
/**
 * @title TestImmediatePOAP
 * @dev Test script to purchase ticket and immediately use it for POAP testing
 */
contract TestImmediatePOAP is Script {
    ...
    function run() external {
        ...
        console.log("Testing Immediate POAP Minting");
        console.log("==============================");
        console.log("");
        ...
        // Step 2: Immediately use the ticket (no time restriction now)
        console.log("Step 2: Using Ticket Immediately...");
        ...
        // Step 4: Check POAP event details
        ...
        console.log("Immediate POAP Test Complete!");
        console.log("=============================");
        if (hasClaimed) {
