...
/**
 * @title CreateNew30SecEvent
 * @dev Script to create a new 30-second event with POAP integration
 */
contract CreateNew30SecEvent is Script {
    ...
    function run() external {
        ...
        console.log("Creating New 30-Second Event with POAP Integration");
        console.log("=================================================");
        console.log("");
        ...
        address eventAddress = factory.createEvent(
            "New 30-Second POAP Integration Test",
        ...
        console.log("New 30-Second POAP Event created at:", eventAddress);
        ...
        console.log("Creating POAP Event for New 30-Second Test...");
        POAP poapContract = POAP(TICKITY_POAP);
        
        uint256 poapEventId = poapContract.createPOAPEvent(
            5, // eventId (assuming this is the next event)
            eventAddress,
            msg.sender, // organizer
            "New 30-Second POAP Integration Test POAP",
            "Proof of attendance for the new 30-second POAP integration test",
            "https://ipfs.io/ipfs/QmNew30SecPOAPTestImage",
            "https://etherlink.com/events/new-30sec-poap-test"
        );
        
        console.log("POAP Event created with ID:", poapEventId);
        console.log("");

        // Purchase a ticket immediately (before event starts)
        ...
        console.log("New 30-Second POAP Test Setup Complete!");
        console.log("=======================================");
        ...
        console.log("2. Run the UseNewTicket script to test POAP minting");
        console.log("3. Verify POAP was minted successfully");
        console.log("");
        console.log("Use this command to run the ticket usage script:");
        console.log("forge script script/UseNewTicket.s.sol --rpc-url https://node.ghostnet.etherlink.com --broadcast --via-ir");
    }
} 